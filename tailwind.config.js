...
module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      'custom': '20px 20px 40px rgba(0, 0, 0, 0.25)',
    ...
    keyframes: {
      ...
      backgroundDarkOpacityMedia: {
        ...
        "100%": { backgroundColor: "#323437" },
      },
      backgroundLightOpacityMedia: {
        "0%": { backgroundColor: "#323437" },
        "50%": { backgroundColor: "#32343788" },
        "100%": { backgroundColor: "rgba(255, 122, 89, 0)" },
      },
      spin: {
        to: {
